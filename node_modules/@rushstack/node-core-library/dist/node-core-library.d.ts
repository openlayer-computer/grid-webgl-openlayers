 ...
 * @public
 */
export declare type FileSystemReadStream = fs.ReadStream;
 ...
 * @public
 */
export declare type FileSystemWriteStream = fs.WriteStream;
 ...
 * @public
 */
export declare interface IFileSystemCreateWriteStreamOptions extends IFileSystemWriteFileOptionsBase {
}
 ...
 * @public
 */
export declare interface IFileSystemMoveOptions extends IFileSystemWriteFileOptionsBase {
    /**
 ...
 * @public
 */
export declare interface IFileSystemWriteBinaryFileOptions extends IFileSystemWriteFileOptionsBase {
}
 ...
 * @public
 */
export declare interface IFileSystemWriteFileOptionsBase {
    /**
 ...
 * @public
 */
declare function mergeWith<TTarget extends object, TSource extends object>(target: TTarget, source: TSource, customizer?: MergeWithCustomizer): TTarget;
 ...
 * @public
 */
declare type MergeWithCustomizer = (objValue: unknown, srcValue: unknown, key: string) => unknown;
